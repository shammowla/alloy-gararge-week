...
describe("validation", () => {
  it("should validate minimum length", () => {
    ...
    expect(checkIf("asd").not().hasMinLength(10).isValid()).toBe(true);

    // Invalid
    expect(checkIf("asd").hasMinLength(10).isValid()).toBe(false);

    expect(checkIf("asd").hasMinLength(10).hasErrors()).toEqual([
  ...
  it("should validate maximum length", () => {
    // Valid
    expect(checkIf("asd").hasMaxLength().isValid()).toBe(true);

    expect(checkIf("asd").hasMaxLength(5).isValid()).toBe(true);

    expect(checkIf("asd").not().hasMaxLength(1).isValid()).toBe(true);
  ...
  it("should validate email", () => {
    ...
    expect(checkIf("email.other@example23.gz").isEmail().isValid()).toBe(true);
    expect(checkIf("bademail@example").not().isEmail().isValid()).toBe(true);
  ...
  it("should validate if has uppercase char", () => {
    // Valid
    ...
    expect(checkIf("aSd").hasUpperCase(2).hasErrors()).toEqual([
      "should have at least 2 uppercase character(s)",
    ]);
  ...
  it("should validate if has lowercase char", () => {
    // Valid
    ...
    expect(checkIf("AsD").hasLowerCase(2).hasErrors()).toEqual([
      "should have at least 2 lowercase character(s)",
    ]);
  ...
  it("should validate if has digit", () => {
    // Valid
    ...
    expect(checkIf("asd12").hasDigit(3).isValid()).toBe(false);
  ...
  it("should validate if matches regex", () => {
    // Valid
    expect(
      checkIf("asd")
        .matches(/[a-z]{2}/g)
  ...
  it("should validate combination of checks", () => {
    // Valid
    expect(
